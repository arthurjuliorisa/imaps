...
export async function GET() {
  try {
    ...
    const worksheet = workbook.addWorksheet('Capital Goods Import Template');
    ...
    const sampleData = [
      [new Date('2025-01-15'), 'CAPITAL-001', 50, 'New scrap received'],
      [new Date('2025-01-16'), 'CAPITAL-002', 75, 'Additional scrap'],
      [new Date('2025-01-17'), 'CAPITAL-001', 30, 'Daily intake'],
    ];
