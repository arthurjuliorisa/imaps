 ...
 * Generates and downloads an Excel template file for production mutation imports
 *
 * Returns:
...
export async function GET() {
  try {
    ...
    const formatHints = ['YYYY-MM-DD', 'e.g., PROD-001', 'Positive number', 'Optional notes'];
    ...
    const instructionsData = [
      ...
      ['1. Fill in your production mutation data starting from Row 3 (after the format hints)'],
      ...
      [],
      ['Item Code:'],
      ['  - The unique code of the scrap item (e.g., PROD-001)'],
      ['  - Required field'],
      ...
      [],
      ['Remarks:'],
      ['  - Optional notes about the production mutation'],
      ...
      ['2025-01-15   | PROD-001   | 50       | New scrap received'],
      ['2025-01-16   | PROD-002   | 75.50    | Additional scrap from production'],
      ['2025-01-17   | PROD-001   | 30       | Daily intake'],
      [],
    ...
    const filename = `Production_Import_Template_${timestamp}.xlsx`;
