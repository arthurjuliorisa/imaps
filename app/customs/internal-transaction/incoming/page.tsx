...
export default function InternalTransactionIncomingPage() {
  ...
  const [data, setData] = useState<InternalTransactionIncomingData[]>([]);
  ...
  return (
    <ReportLayout
      title="Laporan Internal Transaction - Incoming"
      subtitle="Laporan barang masuk dari transaksi internal"
      actions={
        <Stack spacing={3}>
          <DateRangeFilter
            startDate={startDate}
    ...
    >
      ...
      {loading ? (
        ...
        <TableContainer>
          <Table sx={{ minWidth: 650 }} aria-label="internal transaction incoming report table">
            <TableHead>
              <TableRow
                sx={{
