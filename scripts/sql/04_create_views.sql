...
SELECT 
    ...
    wasoi.reason,
    waso.document_date,
    waso.document_date as activation_date,
    waso.status,
    
    -- Linked Adjustment (if adjustment transmitted)
